...
(function ($, rho, rhoUtil) {
    ...
    Sensor.getId = function() { return currentDefaultID; }

    // === Sensor instance properties ===

    rhoUtil.createPropsProxy(Sensor.prototype, [
        { propName: 'minimumGap', propAccess: 'rw' }
      , { propName: 'type', propAccess: 'r' }
      , { propName: 'status', propAccess: 'r' }
    ], apiReq, function(){ return this.getId(); });

    // === Sensor instance methods ===

    rhoUtil.createMethodsProxy(Sensor.prototype, [
    ...
    // === Sensor constants ===
            ...
            Sensor.SENSOR_TYPE_ACCELEROMETER = 'Accelerometer'; 
    
            Sensor.SENSOR_TYPE_TILT_ANGLE = 'TiltAngle'; 
    
            Sensor.SENSOR_TYPE_DEVICE_ORIENTATION = 'DeviceOrientation'; 
    
            Sensor.SENSOR_TYPE_MOTION = 'Motion'; 
    
            Sensor.SENSOR_TYPE_ECOMPASS = 'ECompass'; 
    
            Sensor.SENSOR_TYPE_MAGNETOMETER = 'Magnetometer'; 
    
            Sensor.SENSOR_TYPE_GYROSCOPE = 'Gyroscope'; 
    
            Sensor.SENSOR_TYPE_AMBIENT_LIGHT = 'AmbientLight'; 
    
            Sensor.SENSOR_TYPE_PROXIMITY = 'Proximity'; 
    
            Sensor.SENSOR_TYPE_PROXIMITY_LONG_RANGE = 'ProximityLongRange'; 
    
            Sensor.SENSOR_TYPE_PRESSURE = 'Pressure'; 
    
            Sensor.SENSOR_TYPE_TEMPERATURE = 'Temperature'; 
    
            Sensor.SENSOR_TYPE_HUMIDITY = 'Humidity'; 
    
            Sensor.SENSOR_TYPE_GRAVITY = 'Gravity'; 
    
            Sensor.SENSOR_TYPE_LINEAR_ACCELERATION = 'LinearAcceleration'; 
    
            Sensor.SENSOR_TYPE_ROTATION = 'Rotation'; 
    
            Sensor.SENSOR_TYPE_ORIENTATION = 'Orientation'; 
    
            Sensor.SENSOR_STATUS_NOT_READY = 'not_ready'; 
    
            Sensor.SENSOR_STATUS_READY = 'ready'; 
    
            Sensor.SENSOR_STATUS_STARTED = 'started'; 
    
            Sensor.SENSOR_STATUS_ERROR = 'error'; 
    ...
    // === Sensor hash keys ===
            ...
            Sensor.HK_ACCELEROMETER_X = "accelerometer_x"; 

            Sensor.HK_ACCELEROMETER_Y = "accelerometer_y"; 

            Sensor.HK_ACCELEROMETER_Z = "accelerometer_z"; 

            Sensor.HK_AMBIENTLIGHT_VALUE = "ambientlight_value"; 

            Sensor.HK_DEVICEORIENTATION_VALUE = "deviceorientation_value"; 

            Sensor.HK_ECOMPASS_VALUE = "ecompass_value"; 

            Sensor.HK_GRAVITY_X = "gravity_x"; 

            Sensor.HK_GRAVITY_Y = "gravity_y"; 

            Sensor.HK_GRAVITY_Z = "gravity_z"; 

            Sensor.HK_GYROSCOPE_X = "gyroscope_x"; 

            Sensor.HK_GYROSCOPE_Y = "gyroscope_y"; 

            Sensor.HK_GYROSCOPE_Z = "gyroscope_z"; 

            Sensor.HK_HUMIDITY_VALUE = "humidity_value"; 

            Sensor.HK_LINEARACCELERATION_X = "linearacceleration_x"; 

            Sensor.HK_LINEARACCELERATION_Y = "linearacceleration_y"; 

            Sensor.HK_LINEARACCELERATION_Z = "linearacceleration_z"; 

            Sensor.HK_MAGNETOMETER_X = "magnetometer_x"; 

            Sensor.HK_MAGNETOMETER_Y = "magnetometer_y"; 

            Sensor.HK_MAGNETOMETER_Z = "magnetometer_z"; 

            Sensor.HK_MESSAGE = "message"; 

            Sensor.HK_MOTION_VALUE = "motion_value"; 

            Sensor.HK_ORIENTATION_X = "orientation_x"; 

            Sensor.HK_ORIENTATION_Y = "orientation_y"; 

            Sensor.HK_ORIENTATION_Z = "orientation_z"; 

            Sensor.HK_PRESSURE_VALUE = "pressure_value"; 

            Sensor.HK_PROXIMITYLONGRANGE_VALUE = "proximitylongrange_value"; 

            Sensor.HK_PROXIMITY_VALUE = "proximity_value"; 

            Sensor.HK_ROTATION_X = "rotation_x"; 

            Sensor.HK_ROTATION_Y = "rotation_y"; 

            Sensor.HK_ROTATION_Z = "rotation_z"; 

            Sensor.HK_STATUS = "status"; 

            Sensor.HK_TEMPERATURE_VALUE = "temperature_value"; 

            Sensor.HK_TILTANGLE_X = "tiltangle_x"; 

            Sensor.HK_TILTANGLE_Y = "tiltangle_y"; 

            Sensor.HK_TILTANGLE_Z = "tiltangle_z"; 


    // === Sensor static properties ===

    rhoUtil.createPropsProxy(Sensor, [
    ], apiReq);

    // === Sensor static methods ===

    rhoUtil.createMethodsProxy(Sensor, [
    
          // function(/* const rho::String& */ type, /* optional function */ oResult)
          { methodName: 'makeSensorByType', nativeName: 'makeSensorByType', persistentCallbackIndex: 1, valueCallbackIndex: 3 }
    ...
    // === Sensor default instance support ===
    

    rhoUtil.namespace(moduleNS, Sensor);
