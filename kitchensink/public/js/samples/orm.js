KitchenSink.Samples.ORM = KitchenSink.Samples.ORM || (function($, KitchenSink) {
	...
	function refresh_view() {
		var template = "" + "<tr>" + "<td><%= product.name %></td>" + "<td><%= product.brand %></td>" + "<td><%= product.price %></td>" + "</tr>";
		...
		for (var i = 0; i < products.length; i++) {
			...
			var row_html = "<tr>" + "<td>" + product.get("name") + "</td>" + "<td>" + product.get("brand") + "</td>" + "<td>" + product.get("price") + "</td>" + "</tr><tr>" + "<td colspan='3'><a data-role='button' data-inline='true' data-product-id='" + product.object() + "' class='shuffle_price'>Shuffle price</a>" + "<a data-role='button' data-inline='true' data-product-id='" + product.object() + "' class='delete_product'>Delete</a>" + "</td>" + "</tr>";
